    ...
    <div className="bg-bg-dark rounded-3xl p-5 md:p-6 flex flex-col items-center group relative h-full transition-all hover:shadow-2xl hover:shadow-primary-brown/10">
      ...
      <div className="w-full flex justify-between items-end pb-2 md:pb-4">
        <div className="flex flex-col">
          <h3 className="text-white text-xl md:text-2xl font-bold uppercase tracking-wider mb-1 md:mb-2">{name}</h3>
          <span className="text-secondary-gold text-2xl md:text-3xl font-bold">{price}</span>
        </div>
    ...
    <section className="bg-white py-16 md:py-24 px-6 md:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12 md:mb-16">
          <h4 className="text-primary-brown uppercase tracking-widest mb-2 md:mb-4 font-bold text-sm md:text-base">Featured</h4>
          <h2 className="text-black font-script text-5xl md:text-7xl">Top Products</h2>
        </div>
