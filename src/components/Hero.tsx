  ...
  return (
    <section className="relative min-h-screen w-full bg-[#111111] pt-20 sm:pt-24 pb-8 sm:pb-12 flex items-center overflow-hidden px-4 sm:px-0">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-8 items-center">
        ...
        {/* Left Content */}
        <div className="relative z-10 flex flex-col items-start text-left order-2 lg:order-1 pt-6 sm:pt-10 lg:pt-0">
          <h1 className="text-white font-sans text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-extrabold leading-[1.1] tracking-tight mb-4 sm:mb-6">
            Cita Rasa Asli <br />
          ...
          <a href="#menu" className="bg-[#FFB800] text-black px-6 sm:px-10 py-3 sm:py-4 rounded-full text-base sm:text-lg font-bold hover:bg-yellow-400 transition-all transform hover:scale-105 shadow-[0_4px_20px_rgba(255,184,0,0.3)]">
            Our Menu
          </a>
        ...
        {/* Right Image/Visuals */}
        <div className="relative z-10 w-full h-[300px] sm:h-[400px] md:h-[500px] lg:h-[600px] flex justify-center items-center order-1 lg:order-2 overflow-hidden">
          
          {/* Main Circular Image */}
          <div className="relative w-[200px] h-[200px] sm:w-[280px] sm:h-[280px] md:w-[400px] md:h-[400px] lg:w-[480px] lg:h-[480px] rounded-full p-2 border-2 border-dashed border-[#FFB800]/50 animate-[spin_60s_linear_infinite] hover:animate-none">
