...
export default function Hero() {
  return (
    <section className="relative min-h-screen w-full bg-[#111111] pt-24 pb-12 flex items-center overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 lg:px-12 w-full grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center">
        ...
        <div className="relative z-10 flex flex-col items-start text-left order-2 lg:order-1 pt-10 lg:pt-0">
          ...
          {/* Social Proof */}
          <div className="mt-12 flex flex-col sm:flex-row items-start sm:items-center gap-4 border-t border-white/10 pt-8 w-full md:w-auto">
        ...
        <div className="relative z-10 w-full h-[400px] sm:h-[500px] lg:h-[600px] flex justify-center items-center order-1 lg:order-2">
          ...
          {/* Decorative Elements */}
          <div className="absolute top-[20%] right-[10%] w-3 h-3 bg-[#FFB800] rounded-sm transform rotate-45 animate-pulse"></div>
          <div className="absolute top-[60%] right-[5%] w-2 h-2 bg-white rounded-full animate-ping" style={{animationDuration: '2s'}}></div>
          <div className="absolute bottom-[20%] left-[10%] w-4 h-4 border-2 border-[#FFB800] rounded-full opacity-60"></div>
          
          <div className="absolute top-[5%] right-[25%] md:right-[30%] bg-white p-2 rounded-full shadow-lg transform hover:scale-110 transition-transform">
             <Flame className="w-5 h-5 text-red-500" />
          </div>
          <div className="absolute bottom-[5%] left-[20%] md:left-[30%] bg-white w-10 h-10 flex items-center justify-center text-xl rounded-full shadow-lg leading-none transform hover:scale-110 transition-transform">
             😋
          </div>
        </div>
