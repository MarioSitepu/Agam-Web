      ...
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-2 sm:gap-3 relative z-20">
          ...
          <div className="flex items-center">
            <span className="text-sm xs:text-base md:text-xl lg:text-2xl font-bold text-white uppercase tracking-wider font-sans">
              WARKOP <span className="text-[#FFB800] italic font-script ml-0.5 sm:ml-1 normal-case tracking-normal text-lg md:text-2xl lg:text-3xl">Agam</span>
            </span>
          </div>
        </Link>
