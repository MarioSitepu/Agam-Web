    ...
    <footer className="pt-16 sm:pt-20 pb-8 sm:pb-10 px-4 sm:px-6 md:px-8 border-t border-white/10 bg-bg-dark text-white">
      <div className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 text-center sm:text-left">
        <div className="flex flex-col items-center sm:items-start">
          <h2 className="text-2xl sm:text-3xl font-script text-white mb-4 sm:mb-6">Bakery</h2>
        ...
        <div>
          <h4 className="text-white font-medium mb-4 sm:mb-6 uppercase tracking-wider text-xs sm:text-sm">Products</h4>
          <ul className="space-y-3 sm:space-y-4">
            <li><a href="#" className="text-white/60 hover:text-secondary-gold transition-colors text-sm">Artisanal Bread</a></li>
            <li><a href="#" className="text-white/60 hover:text-secondary-gold transition-colors text-sm">Custom Cakes</a></li>
            <li><a href="#" className="text-white/60 hover:text-secondary-gold transition-colors text-sm">French Pastries</a></li>
            <li><a href="#" className="text-white/60 hover:text-secondary-gold transition-colors text-sm">Seasonal Specials</a></li>
          </ul>
        </div>
      ...
      {/* Decorative text watermark - hidden on mobile, visible only on desktop */}
      <span className="hidden lg:block absolute -bottom-20 -left-10 text-[300px] leading-none text-white/5 font-black uppercase pointer-events-none select-none z-[-1]">
        Bake
      </span>
    </footer>
  );
